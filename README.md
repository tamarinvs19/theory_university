...
* Конспект по вычислимости. Прогресс 6 из 7 лекций, набираю последнюю. На ветке `lecture_5+M` лежит предварительная версия дополнительной лекции математиков, почитанная 12 марта 2021; почти все картинки есть. 
