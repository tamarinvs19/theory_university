...
* Веду конспект по вычислимости. Прогресс 5 из 5 лекций, на вектке `lecture_5+M` лежит предварительная версия без картинок дополнительной лекции математиков, почитанная 12 марта 2021. 
