...
* Веду конспект по вычислимости. Прогресс 5 из 6 лекций, буду набирать последнюю на следующей неделе. На ветке `lecture_5+M` лежит предварительная версия без картинок дополнительной лекции математиков, почитанная 12 марта 2021. 
