...
* Набираю конспект по теории сложности вычисления. Прогресс 2 из 2.
...
Пишите по почте (`tambarsuk239@gmail.com`), в ВК, или исправляйте самостоятельно и делайте `pull request`, или [`issue`](https://github.com/tamarinvs19/theory_university/issues/new).
