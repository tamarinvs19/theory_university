...
\begin{proof}
    ...
    \end{figure}
\end{proof}
\begin{defn}[Бесконечное произведение пространств]
    $ $
    ...
    .\]
    // здесь мог бы быть рисунок, но его нет
\end{defn}
    \begin{figure}[ht]
	\centering
...
\end{ex}
\begin{ex}
    Если склеить $ \overrightarrow{AB}$ и $ \overrightarrow{CD}$, получи  { \bf лента Мебиуса}.
\end{ex}
\begin{defn}
    ...
    .\]
    Фактор пространство $ X /\sim $  обозначается $ X / F$ или $ X \backslash F$
\end{defn}
\begin{thm}
