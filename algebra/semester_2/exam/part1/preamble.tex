...
\mdfdefinestyle{corstyle}{%
    nobreak=true,backgroundcolor=Aquamarine!30,linewidth=0pt,innertopmargin=1pt,innerbottommargin=3pt,
    frametitlebelowskip=0pt,
    frametitleaboveskip=2pt,
}
\mdfdefinestyle{exstyle}{%
    nobreak=true,backgroundcolor=Violet!10,linewidth=0pt,innertopmargin=1pt,innerbottommargin=3pt,
    frametitlebelowskip=1pt,
    frametitleaboveskip=2pt,
}
\mdfdefinestyle{lmstyle}{%
    nobreak=true,backgroundcolor=Mulberry!10,linewidth=0pt,innertopmargin=1pt,innerbottommargin=3pt,
    frametitlebelowskip=1pt,
    frametitleaboveskip=2pt,
}
