...
\usepackage[left=0.7cm,right=0.7cm,top=1.2cm,bottom=1.2cm,bindingoffset=0cm,paperwidth=210mm,paperheight=297mm]{geometry}
...
\mdfdefinestyle{defstyle}{%
    ...
    frametitlerule=true,%
    frametitlebackgroundcolor=ForestGreen!20,%
